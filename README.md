...
## معماری
- **خواندن پیام (`reader.py`)** — روی GitHub Actions، هر ۳۰ دقیقه اجرا می‌شود (این فاصله عمداً
  انتخاب شده تا مصرف دقیقه‌ی Actions روی ریپوی Private از سهمیه‌ی رایگان ماهانه‌ی گیت‌هاب
  (۲۰۰۰ دقیقه) رد نشه — هر ۱۵ دقیقه حدود ۲۹۰۰ دقیقه در ماه مصرف می‌کرد). با اکانت شخصی
